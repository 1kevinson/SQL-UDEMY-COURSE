...
VALUES
    ('voluptatem voluptatem', 3),
    ('voluptatem est ullam', 5),
    ('maiores et sed maiores', 3),
    ('similique reprehenderit', 1),
    ('rerum qui veritatis ut', 5),
    ('ipsum porro deserunt', 2),
    ('Doloribus temporibus hic eveniet', 4),
    ('Ad placeat repellat', 4),
    ('nesciunt blanditiis quae quis', 4),
    ('Culpa perferendis qui perferendis', 2),
    ('Enim doloremque delectus.', 5),
    ('Expedita ducimus cum quibusdam', 1),
    ('Fugiat dignissimos dolorum ', 2),
    ('iusto fugit voluptas et', 5),
    ('Libero eius quo consequatur', 1),
    ('Tenetur quam aut rerum', 2),
    ('Aut et similique porro ullam.', 4),
    ('Enim doloremque delectus.', 5),
